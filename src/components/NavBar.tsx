...
function NavBar({githubUrl} : NavBarProps ): React.ReactElement {
  return (
     <div className="navbar mb-2 bg-base-300 text-neutral-content p-6">
     <img className="rounded-sm" src={logo} width="64px" alt="application logo" />
      ...
      <div className="navbar-end flex gap-2">
        <a aria-label="Github" target="_blank" rel="noreferrer" href={githubUrl} className="btn btn-primary btn-square">
