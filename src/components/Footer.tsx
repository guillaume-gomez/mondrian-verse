...
function Footer({githubUrl} : FooterProps ): React.ReactElement {
  return (
    <footer className="p-4 footer bg-base-300 text-neutral-content footer-center p-6">
      <div>
        <p> 2022 - Made By Guillaume Gomez</p>
        <a href={githubUrl} >Did you enjoyed ? 😊 Star the project </a>
        <a aria-label="Github" target="_blank" rel="noreferrer" href={githubUrl} className="btn btn-square">
